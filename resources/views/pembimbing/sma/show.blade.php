...
<div class="container mx-auto py-8">
    ...
    <div class="mt-4 mr-16">
        <a href="{{ route('pembimbingsma.edit', $user->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Edit Pengguna
        </a>
        ...
        <a href="{{ route('pembimbingsma.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
            Kembali
        </a>
    </div>
</div>
