                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <a href="{{ route('siswasma.show', $item->id) }}" class="text-gray-500 hover:text-gray-100 mr-2">
                                  <i class="material-icons-outlined text-base">visibility</i>
                                </a>
                                <a href="{{ route('siswasma.edit', $item->id) }}" class="text-blue-500 hover:text-blue-700 mr-2">
                                    <i class="material-icons-outlined text-base">edit</i>
                                </a>
                                <form action="{{ route('siswasma.destroy', $item->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
